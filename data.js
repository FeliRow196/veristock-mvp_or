const locationsData = [
    ...
    // --- VULCANIZACION ---
    { type: 'vulcanizacion', name: 'Vulca Móvil El Rápido', lat: -36.825, lng: -73.042, color: '#F59E0B', lastUpdate: 'hace 5 minutos', status: 'En Línea', capacidad: 'Autos y Camionetas', pesoMax: 'Aro 13 a 20', modelo: 'Taller Móvil', conductor: 'Miguel Rojas', telefono: '+56 9 2222 3333' },
    { type: 'vulcanizacion', name: 'Vulca Concepción', lat: -36.829, lng: -73.051, color: '#94A3B8', lastUpdate: 'hace 2 horas', status: 'Fuera de Línea', capacidad: 'Autos y Motos', pesoMax: 'Aro 13 a 18', modelo: 'Taller Fijo', conductor: 'Andrés Díaz', telefono: '+56 9 4444 5555' },
    { type: 'vulcanizacion', name: 'Vulcanización 24/7', lat: -36.818, lng: -73.046, color: '#F59E0B', lastUpdate: 'hace 10 minutos', status: 'En Línea', capacidad: 'Camiones y Buses', pesoMax: 'Todo Aro', modelo: 'Taller Móvil Pesado', conductor: 'Felipe Muñoz', telefono: '+56 9 6666 7777' },
    { type: 'vulcanizacion', name: 'Servicio de Vulca Centro', lat: -36.822, lng: -73.038, color: '#F59E0B', lastUpdate: 'hace 1 minuto', status: 'En Línea', capacidad: 'Vehículos Livianos', pesoMax: 'Hasta Aro 17', modelo: 'Taller Fijo', conductor: 'Carlos Verdugo', telefono: '+56 9 8888 9999' }
];
